...
-- Version: v11.7 (Cognitive Enterprise OS - Absolute Truth)
-- Purpose: Unified Single Source of Truth for Account Intelligence 360
-- ============================================================================
-- 1. ACCOUNT MASTER
...
CREATE TABLE IF NOT EXISTS value_streams (
    ...
    process_owner TEXT,
    linked_strategic_objectives TEXT,
    enabled_mulesoft_capabilities TEXT,
...
-- 11. PLATFORM HEALTH METRICS (Detailed per Platform)
...
-- INDEXES
CREATE INDEX idx_master_account_tenant ON account_master(tenant_id, account_id);
CREATE INDEX idx_master_people_account ON people_team(account_id);
CREATE INDEX idx_master_objectives_status ON strategic_objectives(status);
CREATE INDEX idx_master_engagement_date ON engagement_log(engagement_date);
CREATE INDEX idx_master_insights_date ON generated_insights(date_generated);